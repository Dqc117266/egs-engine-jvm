...
/**
 * Emits Get/Set/Observe use cases for prefs repository methods (scalar or snapshot).
 */
class KmpPrefsUseCaseGenerator(
    private val templateEngine: TemplateEngine,
) {
    private val logger = LoggerFactory.getLogger(KmpPrefsUseCaseGenerator::class.java)
