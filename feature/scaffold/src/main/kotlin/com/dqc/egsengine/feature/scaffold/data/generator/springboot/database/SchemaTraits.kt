...
class SchemaTraitInferrer {
    ...
    fun infer(table: TableSchema, options: SpringBootOpinionatedOptions): SchemaTraits {
        ...
        val hasStatus = table.columns.any {
    ...
    fun columnByName(table: TableSchema, name: String): ColumnSchema? =
