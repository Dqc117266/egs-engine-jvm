...
class SpringBootAppDependencyUpdater {
    ...
    fun ensureFeatureDependency(backendRoot: File, moduleName: String): Boolean {
    ...
    internal fun insertDependency(text: String, dependencyLine: String): String {
        ...
        val newBody = if (featureMatches.isNotEmpty()) {
