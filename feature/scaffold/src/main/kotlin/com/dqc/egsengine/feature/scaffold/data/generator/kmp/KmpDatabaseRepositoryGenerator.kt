...
class KmpDatabaseRepositoryGenerator(
    ...
    fun generateDbOnlyRepository(
        ...
        files.add(
            generatedCommonMain(moduleDir, repositoryPackageName, "$dbRepositoryName.kt", repoInterface),
        )
        files.add(
            generatedCommonMain(moduleDir, repositorySupportPackageName, "$dbRepositorySupportName.kt", repoSupport),
        )
