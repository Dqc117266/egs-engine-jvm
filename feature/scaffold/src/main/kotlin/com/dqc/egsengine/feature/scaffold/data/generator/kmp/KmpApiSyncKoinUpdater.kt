...
class KmpApiSyncKoinUpdater(
    ...
    private fun writeRepositoryImplIfAllowed(
        ...
        val newContent =
            kmpRepositoryImplGenerator.renderDelegationRepositoryImpl(
                template = template,
                includeApi = true,
                includeDb = hasDb,
...
""".trimEnd()
        var replaced =
            if (text.contains(defaultListBlock)) {
...
private fun String.kmpModulePascalCase(): String = split("-", "_")
    .joinToString("") { part ->
